...
n0 = 100 #number of customers
xlength = 1000 #x longitude of the covered area of service [m]
ylength = 1000 #y longitude of the covered area of service [m]
...
B = 1000000 #Budget [€ or other financial unit]
...
mdl.setObjective(cost) #(cost*weighingA+totaltime*weighingB)
...
mdl.setParam('Heuristics',0.7)
mdl.Params.MIPGap = 0.6 #The optimizer stops if 10% is reached
