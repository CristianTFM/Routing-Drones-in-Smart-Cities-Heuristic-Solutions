...
'Initial settings'
rnd = np.random
rnd.seed(0) #To have the same random values
...
mdl.setObjective(cost*weighingA+totaltime*weighingB)
...
mdl.Params.TimeLimit = 600  # seconds The optimizer stops if it has been calculated for 30s
